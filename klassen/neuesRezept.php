...
//         $user_id = $_SESSION['userId']; // Benutzer-ID aus der Session
        ...
        // Validierung
        if (empty($recipeName)) {
            $error_message = "Rezeptname ist ein Pflichtfeld";
        }
        
        //     }else{
        //         die("Ein oder mehrere Formularfelder fehlen.");
...
//         $rezeptid = fuegeRezepteEin($link, $rezeptname, $benutzerid, $beschreibung);
//         $zutaten_ids = fuegeZutatEin($link, $zutaten, $einheiten);
//         fuegeRezeptZutatEin($link, $rezeptid, $zutaten_ids, $mengen);
